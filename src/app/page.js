...
function toast(msg) {
  ...
  Object.assign(t.style, {
    ...
    background: '#111827', border: '1px solid #334155', padding: '10px 14px', borderRadius: '12px',
    color: '#e5e7eb', zIndex: 9999
  });
        ...
        {!session ? (
          ...
          <>
            <div className="grid grid-2">
              <div className="card kpi"><div className="small">Inventory items</div><div className="val">{invCount}</div></div>
              <div className="card kpi"><div className="small">Expiring ≤ 7 days</div><div className="val">{expSoon}</div></div>
            </div>

            <div className="space"></div>

            <div className="grid grid-3">
              <a classNamedd Item</a>
              /log-meal+ Log Meal</a>
              <a className="btn" href="/           </div>
